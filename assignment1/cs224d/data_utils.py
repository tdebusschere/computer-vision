...
class StanfordSentiment:
    ...
    def sentences(self):
        ...
        with open(self.path + "/datasetSentences.txt", "rb") as f:
            ...
            for line in f:
                ...
                sentences += [[w.lower().decode("utf-8").encode('utf-8') for w in splitted]]
    ...
    def sent_labels(self):
        ...
        for i in range(self.numSentences()):
            ...
            sentence = [ word.decode('latin') for word in sentence]
            full_sent = " ".join(sentence).replace('-lrb-', '(').replace('-rrb-', ')')
            try:
             sent_labels[success] = labels[dictionary[full_sent]]
             success = success + 1
            except:
             pass
